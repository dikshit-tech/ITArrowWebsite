        ...
        <div className="outer bg-[#f5f5f5]">
            <div className="inner flex flex-col! gap-10   ">
                <div className="flex flex-col gap-2 items-center w-full">
                    <p className="slogan">Services</p>
                    <h2 className="title">Our <span className="text-[#ff6637]">Top Notch </span> Services
                    </h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8  w-full   justify-between">
                    <div className="w-full p-6 shadow-[#ff6637] bg-white shadow-md justify-between * rounded-2xl overflow-hidden hover:cursor-pointer flex flex-col items-center gap-3" >
                    ...
                    <div className="w-full p-3 shadow-[#ff6637] bg-white shadow-md justify-between * rounded-2xl overflow-hidden hover:cursor-pointer flex flex-col items-center gap-3" >
