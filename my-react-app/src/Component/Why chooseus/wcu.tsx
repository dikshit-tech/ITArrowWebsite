    ...
    return (
        <div className="outer overflow-hidden">
            <div className="inner ">
                ...
                <div className="w-[40%] flex flex-col gap-2 relative p-3 self-start h-[700px] justify-between">
                    ...
                    <div>
                        <img className="w-full rounded-2xl absolute top-20 h-full -left-10 object-contain " src="../patrik_brown.png" alt="" />
                    </div>
                    <div className="w-full flex justify-start items-center gap-3">
                        <div className="w-[50%] p-3 bg-[#201d1c] rounded-2xl z-10 flex flex-col items-center"  >
